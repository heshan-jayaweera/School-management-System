...
<head>
    ...
    <title>Home</title>
    <link href="${pageContext.request.contextPath}/Admin/ad5.css" rel="stylesheet">
...
<body>
    <nav>
        ...
        <ul id="menuList">
            ...
            <li><a href="./ad-users.jsp">Users</a></li>
            <li><a href="./ad-prg.jsp">Programs</a></li>
            <li><a href="./ad-inq.jsp">Inquiries</a></li>
            <li><a class="currentpg" href="#"><i class="fa-solid fa-user"></i> Admin Profile</a></li> <!-- Comment -->
    ...
    <main>
        <div class="cont">
        	...
        	<h1><i class="fa-solid fa-circle-user"></i></i>Admin Profile</h1><br>
        	<div class="seprline"></div>
        	
        	<label class="addetails">User ID : AD0001</label><br>
        	<label class="addetails">Name    : Sam Andrews</label><br>
        	<label class="addetails">Email   : samy@mplwood.com</label><br>
        	<label class="addetails">Phone: +1 978-456-3443</label><br>
        	<label class="addetails">Location : 2232, Brooklyn Ave. ,Orange County, CA</label><br>
        	<label class="addetails">DOB : 10-08-2003</label><br>
        	<label class="addetails">Gender : Male</label><br>
        	<label class="addetails">Admin Type : System</label><br>
        	<label class="addetails">Since: 10-10-2018</label><br><br>
