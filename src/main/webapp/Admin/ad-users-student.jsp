...
<head>
    ...
    <title>Home</title>
    <link href="${pageContext.request.contextPath}/Admin/ad2-1.css" rel="stylesheet">
...
<body>
    ...
    <main>
        <div class="cont">
        	...
        	<div class = "titlebar">
        		<h1>Managers</h1>
        		<div class = "opbar"><ul><li id="adduserbtn">+ Add</li><li id="showtble">View All</li></ul></div>
        	</div>
        	...
        	<br><br>
        		...
        		<div class="formdetails">
        		<label>DOB </label><br>
        		<input type="date" name="mdob">
        		</div><br>
        	
        		<div class="formdetails">
        		<label>Since </label><br>
        		<input type="date" name="msince">
        		</div><br>
        		
        		<input type = "hidden" value="Active" name = "mgstat">
