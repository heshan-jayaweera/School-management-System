    ...
    <main>
        <div class="cont">
        	...
        	<div class = "niform">
        		...
        		<form action="${pageContext.request.contextPath}/sendNewInq" method = "post">
        		
        		<input type = "hidden" value ="AD0001" name = "SenID">
        		<label>TO  </label><br>
 				<input type = "text" name = "recID"><br><br>    
 				
 				<label>Title </label><br>   
 				<input type = "text" name = "inqtitle"><br><br> 	
