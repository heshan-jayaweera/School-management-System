...
<head>
    ...
    <title>Home</title>
    <link href="${pageContext.request.contextPath}/Admin/ad4.css" rel="stylesheet">
...
<body>
    <nav>
        ...
        <ul id="menuList">
            ...
            <li><a class="currentpg" href="#">Inquiries</a></li>
            <li><a href="./ad-prof.jsp"><i class="fa-solid fa-user"></i> Admin Profile</a></li> <!-- Comment -->
    ...
    <main>
        <div class="cont">
        	...
        	<div class = "titlebar">
        		<h1>New Inquiry</h1>
        		<div class = "opbar"><ul><li>+</li></ul></div>
        	</div>
