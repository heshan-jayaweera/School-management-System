...
<body>
    <nav>
        ...
        <ul id="menuList">
            ...
            <li><a href="${pageContext.request.contextPath}/Student/std-assignment.jsp">Assignments</a></li>
            <li><a class="${pageContext.request.contextPath}/Student/std-ing.jsp" href="#">Inquiries</a></li>
    ...
    <h2>Send Inquiry</h2>
    <form action="${pageContext.request.contextPath}/stinq" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" id="receiver" name="to" required>
        </div>
        ...
        <!-- You can set stdID in the servlet -->
