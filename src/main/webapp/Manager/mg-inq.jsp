...
<body>
    <nav>
        ...
        <ul id="menuList">
            ...
            <li><a href="mg-app.jsp">Applicants</a></li>
            <li><a href="mg-payment.jsp">Payment</a></li>
            <li><a class="currentpg" href="mg-inq.jsp">Inquiries</a></li>
            <li><a href="mg-profile.jsp"><i class="fa-solid fa-user"></i> Manager Profile</a></li> <!-- Comment -->
