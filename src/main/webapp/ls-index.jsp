...
<body>
    ...
    <main>
        ...
        <h2>Welcome to Maplewood Highschool – Excellence in Education</h2><br>
        
        <h3>Why Choose Maplewood?</h3>
        <p>Maplewood Highschool is the #1 ranked high school in Los Angeles County. Our certified teachers, interactive virtual classrooms, and flexible schedules provide a top-tier education tailored to every student. With decades of excellence, we combine tradition with innovation to empower learners for success.</p>
        <br>
        <button class = "pgbtn">Explore Programs</button>
        </div>
    ...
    <div class="footersec">
        ...
        <div class="footer-col">
            ...
            <ul>
                ...
                <li><a href="./login.jsp"><i class="fa-solid fa-right-to-bracket"></i> Students Login</a></li>
            </ul>
        </div>
